...
namespace MaltsHopDream {
    public partial class CustomRenderPipeline : RenderPipeline
    {
        ...
        public CustomRenderPipeline(
            ...
            bool useDynamicBating, bool useGPUInstancing, 
        ...
        protected override void Render(ScriptableRenderContext context, List<Camera> cameras)
        {
            for (int i = 0; i < cameras.Count; i++) {
                renderer.Render(context, cameras[i], cameraBufferSettings, useDynamicBating, useGPUInstancing, useLightPerObject,shadowSettings,postFXSettings,colorLUTResolution);
            }
        }
